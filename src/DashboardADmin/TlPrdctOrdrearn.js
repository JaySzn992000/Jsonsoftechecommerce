...
try {
// http://localhost:3001    
const response = await fetch("https://jsonsoftech.site/api/fetchDB");
...
try {
const response = await fetch("https://jsonsoftech.site/api/fetchCutomerOrder");
const data = await response.json();
...
try {
const response = await fetch("https://jsonsoftech.site/api/usertotalnofo");
const data = await response.json();
