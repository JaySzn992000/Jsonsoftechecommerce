...
try {
const response = await axios.post("https://jsonsoftech.site/api/create-order", {
amount: totalAmount,
});
...
"https://jsonsoftech.site/api/verify-payment",
response
);
...
await axios.post(
"https://jsonsoftech.site/api/addcartaddress",
dataToSend
);
resetForm();
