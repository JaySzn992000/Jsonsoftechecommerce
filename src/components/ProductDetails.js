...
useEffect(() => {
fetch(`https://jsonsoftech.site/api/products/${id}`)
.then(res => res.json())
.then(data => {
});
}, [id] );
...
"https://jsonsoftech.site/api/fetchProductslist"
);
...
src={`https://jsonsoftech.site${arrayStore.file_path}`}
alt=''
loading="lazy"
/>
</div>
...
<img
className="product_img"
src={`https://jsonsoftech.site${arrayStore.file_path1}`}
alt=''
loading="lazy"
/>
</div>
...
<img
className="product_img"
src={`https://jsonsoftech.site${arrayStore.file_path2}`}
alt=''
loading="lazy"
/>
</div>
...
<img
className="product_img"
src={`https://jsonsoftech.site${arrayStore.file_path3}`}
alt=''
loading="lazy"
/>
</div>
...
<img
className="product_img"
src={`https://jsonsoftech.site${mainImage}`}
alt={arrayStore.name}
loading="lazy"
/>
</Zoom>
