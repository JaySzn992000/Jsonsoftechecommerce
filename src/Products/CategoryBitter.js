...
useEffect(() => {
axios
.get("https://jsonsoftech.site/api/fetchProductslistSweatshirt")
.then((response) => {
...
if (query) {
axios
.get("https://jsonsoftech.site/api/fetchProductslist", {
params: { search: query },
})
.then((response) => {
...
<img
src={`https://jsonsoftech.site${product.file_path}`}
alt={product.name}
/>
</Link>
